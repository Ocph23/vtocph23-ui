<template>
  <MainLayout>
    <div class="p-6 max-w-4xl mx-auto space-y-6">
      ...
      <p class="text-gray-700">
        vtocph23-ui adalah library komponen UI berbasis Flowbite dan Tailwind CSS yang dikembangkan
        khusus untuk Vue.js 3 (Composition API). Library ini dirancang untuk mempercepat
        pengembangan antarmuka pengguna dengan komponen siap pakai yang konsisten, responsif, dan
        mudah dikustomisasi.
      </p>
  ...
  &lt;/style&gt;</code></pre>
      ...
      <section>
        ...
        <pre
          class="bg-gray-100 p-3 rounded overflow-x-auto"
        ><code>&lt;VtButton color="success" @click="onSave"&gt;
    Simpan Data
  &lt;/VtButton&gt;</code></pre>
        ...
        <pre
          class="bg-gray-100 p-3 rounded overflow-x-auto"
        ><code>&lt;VtModal v-model="showModal" title="Konfirmasi"&gt;
  ...
  &lt;/VtModal&gt;</code></pre>
      ...
      <section>
        ...
        <p>
          Anda dapat menyesuaikan warna, ukuran, atau gaya global dengan memodifikasi konfigurasi
          Tailwind atau menimpa variabel CSS yang disediakan oleh Flowbite dan vtocph23-ui.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Kontribusi sangat diterima! Silakan fork repo ini, buat branch baru
          (<code>feature/nama-fitur</code>), lalu ajukan pull request.
        </p>
      </section>
